  ...
  'discord_integration': {
    ...
    description: `
      ...
      <ul>
        ...
        <li>Logs between Discord and the server.</li>
        <li>Require REQWEST library.</li>
        <li>Easy to use and configure.</li>
      </ul>
    `
  },
  ...
  'ranks': {
    ...
    description: `
      ...
      <ul>
        ...
        <li>Admin can manage ranks and assign them to players.</li>
        <li>Player can see their rank and the rank of other players.</li>
        <li>Easy to use and configure.</li>
      </ul>
    `
  },
  ...
  'wiretaps': {
    ...
    description: `
      ...
      <ul>
        ...
        <li>You can listen to the wiretap frequency while the item is in the world or in your inventory, but you always need to be near the operation table.</li>
        <li>Wiretap receiver got "batteryLife", when it runs out the receiver does not emit anymore and becomes unusable.</li>
        <li>You can generate log paper, all messages the receiver has recorded will be printed on the paper.</li>
        <li>For roleplay purposes, only the description of the people who talk is shown in the wiretap log.</li>
  ...
  'slot-machine': {
    ...
    description: `
      ...
      <ul>
        ...
        <li>This plugin originally came from DarkRP and Clockwork, I found it in one of my old HD and decided to revive it. The model is actually pretty ugly, if someone got modelling skills feel free to update it.</li>
